...
<%block name="title">Data Sources</%block>

<%def name="sidebar()">
    <div class="well well-small">
        <h4>Contents</h4>
        <ul class="unstyled">
            <li><a href="#cultural_data">Cultural data</a></li>
            <li><a href="#linguistic_data">Linguistic data</a></li>
            <li><a href="#env">Environmental data</a></li>
...
<%util:section title="Linguistic data" level="4" id="linguistic_data">
...
<%util:section title="References" level="4" id="ref">
    <ul>
